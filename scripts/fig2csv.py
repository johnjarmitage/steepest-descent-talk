...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 13 11:32:54 2019
...
def extractFig(filename,fignr=1):
   ...
   for line in ax1.children:
       if line.type == 'graph2d.lineseries':
           ...
           flx = pd.DataFrame(data=xy, index=range(0,len(x)), columns=['alpha', 'time'])
           flxname = 'respns_loglog%d.csv' % counter
